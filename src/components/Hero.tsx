      ...
      <div className="container mx-auto px-4 sm:px-6 pt-4 sm:pt-6 pb-8 sm:pb-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center lg:text-left animate-fade-in flex flex-col items-center lg:items-start order-1">
            ...
            {/* Subheadline */}
            <p className="text-base sm:text-lg lg:text-[1.125rem] leading-relaxed max-w-xl text-white/75 mb-5 lg:mb-6 px-1 sm:px-0">Entre na academia sabendo exatamente o que fazer. Mais de 500 pessoas já transformaram seu corpo em 8 semanas<span className="text-white font-medium"></span>. Mais de 500 pessoas já transformaram seu corpo em 8 semanas  <span className="text-accent font-semibold">progresso real</span> — não continue desperdiçando esforço.
            </p>
