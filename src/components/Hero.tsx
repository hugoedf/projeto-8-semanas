        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center max-w-7xl mx-auto">
          ...
          <div className="text-center lg:text-left animate-fade-in px-1 sm:px-0 flex flex-col lg:block">
            ...
            <div className={`order-5 space-y-4 transition-all duration-500 ${vslEnded ? 'scale-105' : ''}`}>
              <Button variant="cta" size="lg" onClick={handleCTAClick} className={`text-base sm:text-lg px-8 sm:px-12 py-6 sm:py-7 w-full sm:w-auto font-bold tracking-wide shadow-xl shadow-accent/25 uppercase ${vslEnded ? 'animate-pulse-glow ring-2 ring-accent/50' : 'animate-pulse-glow'}`}>
                QUERO COMEÇAR AGORA
