    ...
    <section className="py-16 sm:py-20 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 sm:px-6 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Introdução emocional - Texto fluido, não bloco */}
          <div className="text-center mb-10 max-w-[600px] mx-auto">
            <p className="text-slate-500 mb-2" style={{ lineHeight: '1.75' }}>
              E o pior não é treinar pesado.
            </p>
            <p className="text-foreground font-semibold text-lg" style={{ lineHeight: '1.75' }}>
              É sentir que o esforço não está voltando em forma de resultado.
            </p>
            <p className="text-slate-500 mt-4 text-base" style={{ lineHeight: '1.75' }}>
          ...
          {/* 3️⃣ BLOCO ÚNICO "A VERDADE" - Tudo unificado */}
          <div className="truth-unified-block bg-white rounded-2xl shadow-lg shadow-black/[0.05] border border-slate-100 p-6 sm:p-8 md:p-10 mb-10 sm:mb-12">
            
            {/* Badge A VERDADE */}
            <div className="text-center mb-6">
              <span className="inline-block uppercase text-xs font-bold tracking-[0.15em] text-accent bg-accent/10 border border-accent/20 rounded-full px-4 py-2">
                A verdade
              </span>
            </div>
            ...
            {/* Explicação com linha conectora - Flui naturalmente */}
            <div className="relative text-left max-w-[600px] mx-auto">
              {/* Linha vertical conectora */}
              <div className="absolute left-5 top-5 bottom-5 w-px bg-gradient-to-b from-accent/20 via-accent/10 to-transparent hidden sm:block" />
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 pt-1.5">
                        <p className="text-slate-600 text-base" style={{ lineHeight: '1.7' }}>
                          {point.text}{" "}
                          <span className="text-slate-900 font-semibold">{point.highlight}</span>
                        </p>
                        {point.followUp && (
                          <p className="text-slate-500 text-sm mt-2 pl-3 border-l-2 border-accent/25" style={{ lineHeight: '1.7' }}>
                            {point.followUp}
                          </p>
                        )}
                      </div>
            ...
            {/* Insight Quote - Dentro do mesmo bloco */}
            <div className="mt-8 pt-6 border-t border-slate-100 text-center">
              <p className="text-slate-500 italic text-base" style={{ lineHeight: '1.75' }}>
                "Sem um sistema claro, o corpo faz exatamente o que foi programado para fazer:{" "}
                <span className="text-slate-800 font-medium not-italic">se adaptar… e parar de evoluir.</span>"
              </p>
            </div>
          </div>
          
          {/* 5️⃣ Fechamento - Texto leve de transição (NÃO bloco de impacto) */}
          <div className="text-center max-w-[580px] mx-auto">
            <p className="text-slate-500 text-base" style={{ lineHeight: '1.75' }}>
              A maioria das pessoas treina assim por anos.
              Não porque não querem evoluir —
            </p>
            <p className="text-slate-800 font-medium text-base sm:text-lg mt-3" style={{ lineHeight: '1.75' }}>
