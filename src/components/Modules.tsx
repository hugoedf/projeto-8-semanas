      ...
      <div className="container mx-auto px-5 sm:px-6">
        ...
        <div className="text-center mt-12 sm:mt-16 animate-fade-in">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 max-w-2xl mx-auto">
            <p className="text-base sm:text-lg text-white/90 leading-relaxed">​<span className="text-accent font-semibold">O Método 8X não é apenas um treino pronto</span><br />
