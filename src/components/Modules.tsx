...
const Modules = () => {
  return <section id="modules-section" className="py-20 sm:py-28 bg-white">
      <div className="container mx-auto px-5 sm:px-6">
        ...
        <div className="text-center mb-12 max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 text-base sm:text-lg" style={{
          lineHeight: '1.8'
        }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
          {modules.map((module, index) => <div key={index} className="bg-gray-50 border border-gray-100 rounded-xl p-5 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
