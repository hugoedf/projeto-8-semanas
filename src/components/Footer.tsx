...
const Footer = () => {
  return (
    <footer className="py-8 sm:py-12 bg-[#050505]">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-6 sm:mb-8">
            ...
            <p className="text-[#e8e8e8]/70 text-sm sm:text-base px-4">
              Transforme seu corpo com treino inteligente de hipertrofia
            </p>
          </div>
          
          <div className="border-t border-accent/20 pt-6 sm:pt-8">
            <p className="text-[#e8e8e8]/60 text-xs sm:text-sm mb-3 sm:mb-4 px-4">© 2024 Método 8x. Todos os direitos reservados.</p>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm text-[#e8e8e8]/60 px-4">
          ...
          <div className="mt-6 sm:mt-8 text-xs text-[#e8e8e8]/50 px-4">
            <p className="mb-2">
