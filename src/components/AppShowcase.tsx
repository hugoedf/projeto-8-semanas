...
const appFeatures = [{
  icon: Play,
  text: "Treino do dia pronto"
}, {
  icon: BarChart3,
  text: "Acompanha sua evolução"
}, {
  icon: Clock,
  text: "Zero improviso"
}];
  ...
  return <section className="py-20 sm:py-28 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-12 max-w-2xl mx-auto">
          ...
          <p className="text-gray-400 text-base sm:text-lg mb-2" style={{
          lineHeight: '1.8'
        }}>
            A maioria das pessoas sabe o que deveria fazer.
          </p>
          <p className="text-white font-medium text-base sm:text-lg" style={{
          lineHeight: '1.8'
        }}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="backdrop-blur-sm border border-gray-800 rounded-2xl p-6 sm:p-10 bg-muted">
            <div className="grid md:grid-cols-2 gap-10 items-center">
              ...
              <div className="order-1 md:order-2 text-center md:text-left">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-3">
                  ...
                  return <span key={i} className="inline-flex items-center gap-2 bg-accent/15 border border-accent/30 rounded-full px-4 py-2 text-sm text-accent font-medium">
