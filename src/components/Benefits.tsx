    ...
    <section className="py-16 sm:py-24 bg-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-5 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12 lg:mb-16 max-w-3xl mx-auto">
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl mb-4 tracking-tight text-black leading-tight">
            O que você conquista em <span className="text-accent">8 semanas</span>
          </h2>
          <p className="text-gray-600 text-lg sm:text-xl">
            Benefícios tangíveis e emocionais que transformam sua relação com o treino.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto mb-12">
          {tangibleBenefits.map((benefit, index) => {
            ...
            return (
              <div 
                key={index} 
                className="group relative bg-white rounded-2xl p-6 lg:p-7 border border-gray-100 shadow-lg shadow-black/5 hover:shadow-xl hover:border-accent/30 hover:-translate-y-2 transition-all duration-300"
              >
                {/* Keyword badge */}
        ...
        <div className="bg-gradient-to-br from-gray-50 to-white rounded-3xl p-6 sm:p-8 lg:p-10 shadow-xl shadow-black/5 border border-gray-100 max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {emotionalBullets.map((bullet, index) => (
              <div key={index} className="flex items-center gap-4 bg-white border border-gray-100 rounded-xl px-5 py-4 shadow-sm hover:shadow-md hover:border-accent/20 transition-all duration-200">
