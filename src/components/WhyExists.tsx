...
          
{/* Header - Impacto Original com Calibragem de Fonte */}
<div className="text-center mb-10 lg:mb-16"> 
  <h2 className="font-display text-[22px] sm:text-4xl md:text-5xl tracking-tight text-black leading-[1.2] mb-6 px-4">
