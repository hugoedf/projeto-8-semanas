      ...
      <div className="container mx-auto px-5 sm:px-6">
        <div className="max-w-[650px] mx-auto">
          ...
          <div className="bg-slate-50 rounded-2xl p-6 sm:p-8 md:p-10 border border-slate-100 shadow-md shadow-black/[0.04]">
            ...
            {/* Narrativa fluida como história - ALINHADO À ESQUERDA */}
            <p className="text-slate-600 text-sm sm:text-base mb-5 text-left" style={{ lineHeight: '1.75' }}>
            ...
            <div className="flex items-start gap-3 bg-white border border-slate-200 rounded-xl p-4 sm:p-5 mb-5 shadow-sm text-left">
            ...
            <p className="text-foreground text-sm sm:text-base text-left" style={{ lineHeight: '1.75' }}>
