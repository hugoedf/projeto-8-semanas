        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
            {pillars.map((pillar, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-5 lg:p-6 shadow-lg shadow-black/5 border border-black/5 hover:shadow-xl hover:border-accent/20 hover:-translate-y-1 transition-all duration-300"
              >
          ...
          <div className="bg-white rounded-xl p-5 sm:p-6 shadow-lg shadow-black/5 border border-black/5 mb-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 max-w-3xl mx-auto">
              {resultBullets.map((bullet, index) => (
                <div
                  key={index}
                  className="flex items-center gap-2 bg-accent/5 border border-accent/15 rounded-lg px-3 py-2.5"
                >
