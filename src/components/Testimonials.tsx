  ...
  testimonial: typeof testimonials[0];
    ...
    <div className="flex items-center gap-3 mb-4">
      <div className="relative">
        <img src={testimonial.image} alt={testimonial.name} className="w-14 h-14 rounded-full object-cover border-2 border-accent/20" loading="lazy" />
...
const Testimonials = () => {
  return <section className="py-12 sm:py-16 bg-[#F5F5F5] relative overflow-hidden">
      {/* Glow de fundo */}
        ...
        <div className="block lg:hidden">
          ...
          loop: true
            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {testimonials.map((testimonial, index) => <CarouselItem key={index} className="pl-2 md:pl-4 basis-full sm:basis-1/2">
                  <div className="p-1">
